...
class NumberSearchApi(object):
    ...
    def numbersearch_get(self, **kwargs):  # noqa: E501
        ...
        :param str country: Filter by country ISO. Only one country can be filtered at a time. If not country is provided results for United States are returned by default. 
