...
class PhoneNumberService(object):
    ...
    def __init__(self, sms=None):  # noqa: E501
        """PhoneNumberService - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def sms(self):
        """Gets the sms of this PhoneNumberService.  # noqa: E501

        `true` if sms service is available on this number  # noqa: E501

        :return: The sms of this PhoneNumberService.  # noqa: E501
        :rtype: bool
        """
        return self._sms
    ...
    @sms.setter
    def sms(self, sms):
        """Sets the sms of this PhoneNumberService.

        `true` if sms service is available on this number  # noqa: E501

        :param sms: The sms of this PhoneNumberService.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PhoneNumberService):
            return False
