...
class CreateMessageContentLocation(object):
    ...
    def __init__(self, longitude=None, latitude=None, label=None, address=None):  # noqa: E501
        """CreateMessageContentLocation - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def longitude(self):
        """Gets the longitude of this CreateMessageContentLocation.  # noqa: E501

        Longitude of the location to be sent  # noqa: E501

        :return: The longitude of this CreateMessageContentLocation.  # noqa: E501
        :rtype: str
        """
    ...
    def longitude(self, longitude):
        """Sets the longitude of this CreateMessageContentLocation.

        Longitude of the location to be sent  # noqa: E501

        :param longitude: The longitude of this CreateMessageContentLocation.  # noqa: E501
        :type: str
        """
    ...
    @property
    def latitude(self):
        """Gets the latitude of this CreateMessageContentLocation.  # noqa: E501

        Latitude of the location to be sent  # noqa: E501

        :return: The latitude of this CreateMessageContentLocation.  # noqa: E501
        :rtype: str
        """
    ...
    def latitude(self, latitude):
        """Sets the latitude of this CreateMessageContentLocation.

        Latitude of the location to be sent  # noqa: E501

        :param latitude: The latitude of this CreateMessageContentLocation.  # noqa: E501
        :type: str
        """
        if latitude is None:
    ...
    @property
    def label(self):
        """Gets the label of this CreateMessageContentLocation.  # noqa: E501

        Label which will be attached as heading to the location  # noqa: E501

        :return: The label of this CreateMessageContentLocation.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this CreateMessageContentLocation.

        Label which will be attached as heading to the location  # noqa: E501

        :param label: The label of this CreateMessageContentLocation.  # noqa: E501
        :type: str
        """
        if label is None:
    ...
    @property
    def address(self):
        """Gets the address of this CreateMessageContentLocation.  # noqa: E501

        Address which will be attached to the location  # noqa: E501

        :return: The address of this CreateMessageContentLocation.  # noqa: E501
        :rtype: str
        """
    ...
    def address(self, address):
        """Sets the address of this CreateMessageContentLocation.

        Address which will be attached to the location  # noqa: E501

        :param address: The address of this CreateMessageContentLocation.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateMessageContentLocation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateMessageContentLocation):
            return False
