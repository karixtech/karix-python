...
class EditWebhook(object):
    ...
    def __init__(self, sms_notification_url=None, sms_notification_method=None, sms_notification_fallback_url=None, sms_notification_fallback_method=None, name=None):  # noqa: E501
        """EditWebhook - a model defined in Swagger"""  # noqa: E501
    ...
    def sms_notification_url(self):
        """Gets the sms_notification_url of this EditWebhook.  # noqa: E501

        API url to notify in case of inbound message  # noqa: E501

        :return: The sms_notification_url of this EditWebhook.  # noqa: E501
        :rtype: str
        """
    ...
    def sms_notification_url(self, sms_notification_url):
        """Sets the sms_notification_url of this EditWebhook.

        API url to notify in case of inbound message  # noqa: E501

        :param sms_notification_url: The sms_notification_url of this EditWebhook.  # noqa: E501
        :type: str
        """
    ...
    def sms_notification_method(self):
        """Gets the sms_notification_method of this EditWebhook.  # noqa: E501

        HTTP method to use for notifying API url in case of inbound message  # noqa: E501

        :return: The sms_notification_method of this EditWebhook.  # noqa: E501
        :rtype: str
        """
    ...
    def sms_notification_method(self, sms_notification_method):
        """Sets the sms_notification_method of this EditWebhook.

        HTTP method to use for notifying API url in case of inbound message  # noqa: E501

        :param sms_notification_method: The sms_notification_method of this EditWebhook.  # noqa: E501
        :type: str
        """
    ...
    def sms_notification_fallback_url(self):
        """Gets the sms_notification_fallback_url of this EditWebhook.  # noqa: E501
        ...
        :return: The sms_notification_fallback_url of this EditWebhook.  # noqa: E501
        :rtype: str
        """
    ...
    def sms_notification_fallback_url(self, sms_notification_fallback_url):
        """Sets the sms_notification_fallback_url of this EditWebhook.

        In case the service for `sms_notification_url` is down Karix will hit the fallback url with the incoming message details   # noqa: E501

        :param sms_notification_fallback_url: The sms_notification_fallback_url of this EditWebhook.  # noqa: E501
        :type: str
        """
    ...
    def sms_notification_fallback_method(self):
        """Gets the sms_notification_fallback_method of this EditWebhook.  # noqa: E501

        HTTP method to use for fallback notification url  # noqa: E501

        :return: The sms_notification_fallback_method of this EditWebhook.  # noqa: E501
        :rtype: str
        """
    ...
    def sms_notification_fallback_method(self, sms_notification_fallback_method):
        """Sets the sms_notification_fallback_method of this EditWebhook.

        HTTP method to use for fallback notification url  # noqa: E501

        :param sms_notification_fallback_method: The sms_notification_fallback_method of this EditWebhook.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this EditWebhook.  # noqa: E501

        Display name of the webhook  # noqa: E501

        :return: The name of this EditWebhook.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this EditWebhook.

        Display name of the webhook  # noqa: E501

        :param name: The name of this EditWebhook.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EditWebhook, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EditWebhook):
            return False
