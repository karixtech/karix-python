...
class InlineResponse500Error(object):
    ...
    def __init__(self, message=None, param=None):  # noqa: E501
        """InlineResponse500Error - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def message(self):
        """Gets the message of this InlineResponse500Error.  # noqa: E501

        Error Message  # noqa: E501

        :return: The message of this InlineResponse500Error.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this InlineResponse500Error.

        Error Message  # noqa: E501

        :param message: The message of this InlineResponse500Error.  # noqa: E501
        :type: str
        """
        if message is None:
    ...
    @property
    def param(self):
        """Gets the param of this InlineResponse500Error.  # noqa: E501

        Parameter the error message is related to `null` is the error is generic   # noqa: E501

        :return: The param of this InlineResponse500Error.  # noqa: E501
        :rtype: str
        """
        return self._param
    ...
    def param(self, param):
        """Sets the param of this InlineResponse500Error.

        Parameter the error message is related to `null` is the error is generic   # noqa: E501

        :param param: The param of this InlineResponse500Error.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InlineResponse500Error, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse500Error):
            return False
