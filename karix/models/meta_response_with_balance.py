...
class MetaResponseWithBalance(object):
    ...
    def __init__(self, request_uuid=None, credits_charged=None, available_credits=None):  # noqa: E501
        """MetaResponseWithBalance - a model defined in Swagger"""  # noqa: E501

        self._request_uuid = None
        self._credits_charged = None
    ...
    def request_uuid(self):
        """Gets the request_uuid of this MetaResponseWithBalance.  # noqa: E501

        Unique request ID for debugging purposes  # noqa: E501

        :return: The request_uuid of this MetaResponseWithBalance.  # noqa: E501
        :rtype: str
        """
    ...
    def request_uuid(self, request_uuid):
        """Sets the request_uuid of this MetaResponseWithBalance.

        Unique request ID for debugging purposes  # noqa: E501

        :param request_uuid: The request_uuid of this MetaResponseWithBalance.  # noqa: E501
        :type: str
        """
    ...
    def credits_charged(self):
        """Gets the credits_charged of this MetaResponseWithBalance.  # noqa: E501
    ...
    @credits_charged.setter
    def credits_charged(self, credits_charged):
        """Sets the credits_charged of this MetaResponseWithBalance.
    ...
    def available_credits(self):
        """Gets the available_credits of this MetaResponseWithBalance.  # noqa: E501
    ...
    def available_credits(self, available_credits):
        """Sets the available_credits of this MetaResponseWithBalance.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MetaResponseWithBalance, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetaResponseWithBalance):
            return False
