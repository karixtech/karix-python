...
class MessageError(object):
    ...
    def __init__(self, code=None, message=None):  # noqa: E501
        """MessageError - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def code(self):
        """Gets the code of this MessageError.  # noqa: E501

        Error code of the failure  # noqa: E501

        :return: The code of this MessageError.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this MessageError.

        Error code of the failure  # noqa: E501

        :param code: The code of this MessageError.  # noqa: E501
        :type: str
        """
        if code is None:
    ...
    @property
    def message(self):
        """Gets the message of this MessageError.  # noqa: E501

        Error message corresponding to the error `code`.  # noqa: E501

        :return: The message of this MessageError.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this MessageError.

        Error message corresponding to the error `code`.  # noqa: E501

        :param message: The message of this MessageError.  # noqa: E501
        :type: str
        """
        if message is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MessageError, dict):
