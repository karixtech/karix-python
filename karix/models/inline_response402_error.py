...
class InlineResponse402Error(object):
    ...
    def __init__(self, message=None):  # noqa: E501
        """InlineResponse402Error - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def message(self):
        """Gets the message of this InlineResponse402Error.  # noqa: E501

        Insufficient Balance Message  # noqa: E501

        :return: The message of this InlineResponse402Error.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this InlineResponse402Error.

        Insufficient Balance Message  # noqa: E501

        :param message: The message of this InlineResponse402Error.  # noqa: E501
        :type: str
        """
        if message is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InlineResponse402Error, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse402Error):
            return False
