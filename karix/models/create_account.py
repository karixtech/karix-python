...
class CreateAccount(object):
    ...
    def __init__(self, name=None, status='enabled'):  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this CreateAccount.  # noqa: E501

        Status of your account. Possible values are:   - enabled: Account is ready to be used   - suspended: Account has been temporarily suspended   - disabled: Account has been permanently disabled and             cannot be revived. All resources like numbers             allocated to the subaccount will not be deleted             and can be transferred to an enabled account.   `suspended` and `disabled` accounts cannot use Karix API. They will receive   `403 Forbidden` response.   # noqa: E501

        :return: The status of this CreateAccount.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this CreateAccount.

        Status of your account. Possible values are:   - enabled: Account is ready to be used   - suspended: Account has been temporarily suspended   - disabled: Account has been permanently disabled and             cannot be revived. All resources like numbers             allocated to the subaccount will not be deleted             and can be transferred to an enabled account.   `suspended` and `disabled` accounts cannot use Karix API. They will receive   `403 Forbidden` response.   # noqa: E501

        :param status: The status of this CreateAccount.  # noqa: E501
        :type: str
        """
