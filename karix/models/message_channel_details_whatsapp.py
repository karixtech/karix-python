...
class MessageChannelDetailsWhatsapp(object):
    ...
    def __init__(self, type=None, platform_fee=None, whatsapp_fee=None):  # noqa: E501
        """MessageChannelDetailsWhatsapp - a model defined in Swagger"""  # noqa: E501

        self._type = None
        self._platform_fee = None
        self._whatsapp_fee = None
        self.discriminator = None

        self.type = type
        self.platform_fee = platform_fee
        self.whatsapp_fee = whatsapp_fee

    @property
    def type(self):
        """Gets the type of this MessageChannelDetailsWhatsapp.  # noqa: E501

        Message type used to send over whatsapp. Whatsapp supports types: - `conversation`: Message sent within the free window of whatsapp - `notification`: Message sent using a whatsapp template Whatsapp charges differ according to message type   # noqa: E501

        :return: The type of this MessageChannelDetailsWhatsapp.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this MessageChannelDetailsWhatsapp.

        Message type used to send over whatsapp. Whatsapp supports types: - `conversation`: Message sent within the free window of whatsapp - `notification`: Message sent using a whatsapp template Whatsapp charges differ according to message type   # noqa: E501

        :param type: The type of this MessageChannelDetailsWhatsapp.  # noqa: E501
        :type: str
        """
        if type is None:
            raise ValueError("Invalid value for `type`, must not be `None`")  # noqa: E501
        allowed_values = ["conversation", "notification"]  # noqa: E501
    ...
    def platform_fee(self):
        """Gets the platform_fee of this MessageChannelDetailsWhatsapp.  # noqa: E501

        Fees charged by Karix platform for this message   # noqa: E501

        :return: The platform_fee of this MessageChannelDetailsWhatsapp.  # noqa: E501
        :rtype: str
        """
    ...
    def platform_fee(self, platform_fee):
        """Sets the platform_fee of this MessageChannelDetailsWhatsapp.

        Fees charged by Karix platform for this message   # noqa: E501

        :param platform_fee: The platform_fee of this MessageChannelDetailsWhatsapp.  # noqa: E501
        :type: str
        """
        if platform_fee is None:
            raise ValueError("Invalid value for `platform_fee`, must not be `None`")  # noqa: E501

        self._platform_fee = platform_fee

    @property
    def whatsapp_fee(self):
        """Gets the whatsapp_fee of this MessageChannelDetailsWhatsapp.  # noqa: E501

        Fees charged by WhatsApp for this message   # noqa: E501

        :return: The whatsapp_fee of this MessageChannelDetailsWhatsapp.  # noqa: E501
        :rtype: str
        """
        return self._whatsapp_fee

    @whatsapp_fee.setter
    def whatsapp_fee(self, whatsapp_fee):
        """Sets the whatsapp_fee of this MessageChannelDetailsWhatsapp.

        Fees charged by WhatsApp for this message   # noqa: E501

        :param whatsapp_fee: The whatsapp_fee of this MessageChannelDetailsWhatsapp.  # noqa: E501
        :type: str
        """
        if whatsapp_fee is None:
            raise ValueError("Invalid value for `whatsapp_fee`, must not be `None`")  # noqa: E501

        self._whatsapp_fee = whatsapp_fee
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MessageChannelDetailsWhatsapp, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MessageChannelDetailsWhatsapp):
            return False
