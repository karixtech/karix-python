...
setup(
    name=NAME,
    version=VERSION,
    description="karix api",
    author_email="apiteam@karix.com",
    url="",
    keywords=["Swagger", "karix api"],
    install_requires=REQUIRES,
    packages=find_packages(),
    include_package_data=True,
    long_description="""\
    Overview  Karix API lets you interact with the Karix platform. It allows you to query your account, set up webhooks, send messages and buy phone numbers.   # noqa: E501
    """
)
