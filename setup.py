...
setup(
    ...
    author_email="support@karix.com",
    ...
    long_description="""\
    Karix API lets you interact with the Karix platform. It allows you to query your account, set up webhooks, send messages and buy phone numbers.   # noqa: E501
    """
)
