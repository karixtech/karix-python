...
import karix
from karix.api.number_search_api import NumberSearchApi  # noqa: E501
from karix.rest import ApiException


class TestNumberSearchApi(unittest.TestCase):
    """NumberSearchApi unit test stubs"""

    def setUp(self):
        self.api = karix.api.number_search_api.NumberSearchApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_numbersearch_get(self):
        """Test case for numbersearch_get
