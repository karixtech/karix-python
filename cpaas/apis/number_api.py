...
class NumberApi(object):
    ...
    def get_number(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_number(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.get_number_with_http_info(**kwargs)
        else:
            (data) = self.get_number_with_http_info(**kwargs)
            return data

    def get_number_with_http_info(self, **kwargs):
        """
        Get details of all phone numbers linked to your account.
        Get details of all phone numbers linked to your account.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_number_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/number/', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def number_num_delete(self, num, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.number_num_delete(num, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.number_num_delete_with_http_info(num, **kwargs)
        else:
            (data) = self.number_num_delete_with_http_info(num, **kwargs)
            return data

    def number_num_delete_with_http_info(self, num, **kwargs):
        """
        Unrent number from your account
        Unrent number from your account
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.number_num_delete_with_http_info(num, callback=callback_function)
        ...
        if ('num' not in params) or (params['num'] is None):
            raise ValueError("Missing the required parameter `num` when calling `number_num_delete`")
        ...
        return self.api_client.call_api('/number/{num}/', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def number_num_get(self, num, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.number_num_get(num, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.number_num_get_with_http_info(num, **kwargs)
        else:
            (data) = self.number_num_get_with_http_info(num, **kwargs)
            return data

    def number_num_get_with_http_info(self, num, **kwargs):
        """
        Get details of a number
        Get details of a number
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.number_num_get_with_http_info(num, callback=callback_function)
        ...
        # verify the required parameter 'num' is set
        if ('num' not in params) or (params['num'] is None):
            raise ValueError("Missing the required parameter `num` when calling `number_num_get`")
        ...
        return self.api_client.call_api('/number/{num}/', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def number_num_patch(self, num, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.number_num_patch(num, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.number_num_patch_with_http_info(num, **kwargs)
        else:
            (data) = self.number_num_patch_with_http_info(num, **kwargs)
            return data

    def number_num_patch_with_http_info(self, num, **kwargs):
        """
        Edit phone number belonging to your account
        Edit phone number belonging to your account
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.number_num_patch_with_http_info(num, callback=callback_function)
        ...
        # verify the required parameter 'num' is set
        if ('num' not in params) or (params['num'] is None):
            raise ValueError("Missing the required parameter `num` when calling `number_num_patch`")
        ...
        return self.api_client.call_api('/number/{num}/', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
