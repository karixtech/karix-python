...
class WebhookApi(object):
    ...
    def create_webhook_with_http_info(self, **kwargs):
        ...
        all_params = ['api_version', 'webhook']
        ...
        return self.api_client.call_api('/webhook/', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def delete_webhook_by_id(self, uid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_webhook_by_id(uid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_webhook_by_id_with_http_info(uid, **kwargs)
        else:
            (data) = self.delete_webhook_by_id_with_http_info(uid, **kwargs)
            return data

    def delete_webhook_by_id_with_http_info(self, uid, **kwargs):
        """
        Delete a webhook by ID
        Delete a webhook by ID
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_webhook_by_id_with_http_info(uid, callback=callback_function)
        ...
        if ('uid' not in params) or (params['uid'] is None):
            raise ValueError("Missing the required parameter `uid` when calling `delete_webhook_by_id`")
        ...
        return self.api_client.call_api('/webhook/{uid}/', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_webhook(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_webhook(callback=callback_function)
    ...
    def get_webhook_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_webhook_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/webhook/', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_webhook_by_id(self, uid, **kwargs):
        """
        Get a webhook by ID
        Get a webhook by ID
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_webhook_by_id(uid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_webhook_by_id_with_http_info(uid, **kwargs)
        else:
            (data) = self.get_webhook_by_id_with_http_info(uid, **kwargs)
            return data

    def get_webhook_by_id_with_http_info(self, uid, **kwargs):
        """
        Get a webhook by ID
        Get a webhook by ID
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_webhook_by_id_with_http_info(uid, callback=callback_function)
        ...
        # verify the required parameter 'uid' is set
        if ('uid' not in params) or (params['uid'] is None):
            raise ValueError("Missing the required parameter `uid` when calling `get_webhook_by_id`")
        ...
        return self.api_client.call_api('/webhook/{uid}/', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def patch_webhook(self, uid, **kwargs):
        """
        Edit a webhook
        Edit a webhook
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.patch_webhook(uid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.patch_webhook_with_http_info(uid, **kwargs)
        else:
            (data) = self.patch_webhook_with_http_info(uid, **kwargs)
            return data

    def patch_webhook_with_http_info(self, uid, **kwargs):
        """
        Edit a webhook
        Edit a webhook
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.patch_webhook_with_http_info(uid, callback=callback_function)
        ...
        all_params = ['uid', 'api_version', 'webhook']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'uid' is set
        if ('uid' not in params) or (params['uid'] is None):
            raise ValueError("Missing the required parameter `uid` when calling `patch_webhook`")
        ...
        return self.api_client.call_api('/webhook/{uid}/', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
