...
class AccountsApi(object):
    ...
    def create_subaccount(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_subaccount(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.create_subaccount_with_http_info(**kwargs)
        else:
            (data) = self.create_subaccount_with_http_info(**kwargs)
            return data

    def create_subaccount_with_http_info(self, **kwargs):
        """
        Create a new subaccount
        Create a new subaccount under your account
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_subaccount_with_http_info(callback=callback_function)
        ...
        all_params = ['api_version', 'subaccount']
    ...
    def get_subaccount(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_subaccount(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_subaccount_with_http_info(**kwargs)
        else:
            (data) = self.get_subaccount_with_http_info(**kwargs)
            return data

    def get_subaccount_with_http_info(self, **kwargs):
        """
        Get a list of accounts
        Get a list of details of all subaccounts, including the main account. Accounts are sorted by last updated time.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_subaccount_with_http_info(callback=callback_function)
        ...
        all_params = ['api_version', 'offset', 'limit']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_subaccount_by_id(self, uid, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_subaccount_by_id(uid, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_subaccount_by_id_with_http_info(uid, **kwargs)
        else:
            (data) = self.get_subaccount_by_id_with_http_info(uid, **kwargs)
            return data

    def get_subaccount_by_id_with_http_info(self, uid, **kwargs):
        """
        Get details of an account
        Get details of an account by its uid. Both main account and subaccounts can be fetched using their uids. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_subaccount_by_id_with_http_info(uid, callback=callback_function)
        ...
        if ('uid' not in params) or (params['uid'] is None):
            raise ValueError("Missing the required parameter `uid` when calling `get_subaccount_by_id`")
        ...
        return self.api_client.call_api('/accounts/{uid}/', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def patch_subaccount(self, uid, **kwargs):
        """
        Edit an account
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.patch_subaccount(uid, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str uid: Alphanumeric ID of the account/subaccount to edit. (required)
        :param str api_version: API Version. If not specified your pinned verison is used.
        :param EditableAccount subaccount: Subaccount object
        :return: InlineResponse2001
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.patch_subaccount_with_http_info(uid, **kwargs)
        else:
            (data) = self.patch_subaccount_with_http_info(uid, **kwargs)
            return data

    def patch_subaccount_with_http_info(self, uid, **kwargs):
        """
        Edit an account
        Edit details of your account or its subaccount   - An account can only change the status of subaccounts under it.     It cant change its own status   - A parent account can edit its own details and the details of its subaccounts 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.patch_subaccount_with_http_info(uid, callback=callback_function)
        ...
        all_params = ['uid', 'api_version', 'subaccount']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'uid' is set
        if ('uid' not in params) or (params['uid'] is None):
            raise ValueError("Missing the required parameter `uid` when calling `patch_subaccount`")
        ...
        return self.api_client.call_api('/accounts/{uid}/', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
