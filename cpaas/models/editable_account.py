...
class EditableAccount(object):
    ...
    def __init__(self, name=None, status=None):
        """
        EditableAccount - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this EditableAccount.
        Name of the account. Must be unique within the parent account. 

        :return: The name of this EditableAccount.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this EditableAccount.
        Name of the account. Must be unique within the parent account. 

        :param name: The name of this EditableAccount.
        :type: str
        """
        if name is None:
    ...
    def status(self):
        """
        Gets the status of this EditableAccount.
        ...
        :return: The status of this EditableAccount.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """
        Sets the status of this EditableAccount.
        Status of your account. Possible values are:   - enabled: Account is ready to be used   - suspended: Account has been temporarily suspended   - disabled: Account has been permanently disabled and             cannot be revived. All resources allocated             to the subaccount like phonenumbers are also             deleted. 

        :param status: The status of this EditableAccount.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, EditableAccount):
            return False
