...
class WebhookResponse(object):
    ...
    def __init__(self, sms_notification_url=None, sms_notification_method=None, uid=None):
        """
    ...
    def sms_notification_url(self):
        """
        Gets the sms_notification_url of this WebhookResponse.

        :return: The sms_notification_url of this WebhookResponse.
        :rtype: str
        """
    ...
    def sms_notification_url(self, sms_notification_url):
        """
        Sets the sms_notification_url of this WebhookResponse.

        :param sms_notification_url: The sms_notification_url of this WebhookResponse.
        :type: str
        """
    ...
    def sms_notification_method(self):
        """
        Gets the sms_notification_method of this WebhookResponse.

        :return: The sms_notification_method of this WebhookResponse.
        :rtype: str
        """
    ...
    def sms_notification_method(self, sms_notification_method):
        """
        Sets the sms_notification_method of this WebhookResponse.

        :param sms_notification_method: The sms_notification_method of this WebhookResponse.
        :type: str
        """
    ...
    def uid(self):
        """
        Gets the uid of this WebhookResponse.

        :return: The uid of this WebhookResponse.
        :rtype: str
        """
        return self._uid
    ...
    def uid(self, uid):
        """
        Sets the uid of this WebhookResponse.

        :param uid: The uid of this WebhookResponse.
        :type: str
        """
